...
//Criar lista com as normas e tratamento de erro
...
//Criar um arquivo json com a lista
function CriarJson(propriedades) {  
  ...
  .then((answer) => {
    if(answer.arquivo == 'sim'){
      ...
      fs.writeFileSync(`propriedades/${lista}.json`, `{"propriedades": [${propriedades}]}`, //criar arquivo
      function (err){
        console.log(err)
      },)
